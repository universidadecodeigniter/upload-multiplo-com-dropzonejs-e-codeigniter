...
<html lang="pt_BR">
  <head>
    ...
    <meta name="description" content="Tutorial ensinando como desenvolver um sistema de upload múltiplo com CodeIgniter e DropzoneJS">
    <meta name="author" content="Universidade CodeIgniter">
    <link rel="icon" href="<?=base_url('assets/images/unici/favicon.png')?>">

    <title>Upload múltiplo com CodeIgniter e DropzoneJS</title>
    ...
    <!-- Folha de estilo do DropzoneJS -->
    <link href="<?=base_url('assets/css/plugins/dropzone.css')?>" type="text/css" rel="stylesheet" />
